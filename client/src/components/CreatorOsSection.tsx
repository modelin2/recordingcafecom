      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-4">
            <span style={{ color: '#D4AF37' }}>AI × Entertainment × Finance</span>로<br className="hidden sm:block" />
            창작자의 생애 수익 구조를 설계하는 컴퍼니 빌더
          </p>

          <p className="text-lg text-muted-foreground/80 max-w-2xl mx-auto">
            AI 기술로 창작자의 꿈을 현실로 만드는 여정을 함께합니다
          </p>
        </div>
            ...
            <Card key={index} className="border-border/50 hover-elevate" data-testid={`card-pipeline-${index}`}>
              <CardContent className="p-8">
                <div className="w-14 h-14 rounded-lg bg-primary/10 flex items-center justify-center mb-6">
                  <pipeline.icon className="h-7 w-7" style={{ color: '#D4AF37' }} />
                </div>
